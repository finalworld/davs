...
ui.againBtn.addEventListener('click',()=>{state=null;confirmedName='';ui.nameInput.value='';ui.nameStatus.textContent='';ui.startBtn.disabled=true;ui.result.classList.remove('show');ui.start.classList.add('show');loadLeaderboard(ui.startLeaderboard);});
...
loadLeaderboard(ui.startLeaderboard);
